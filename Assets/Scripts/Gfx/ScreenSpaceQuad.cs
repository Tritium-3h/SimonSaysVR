...
namespace GVR.Gfx {
  ...
  public class ScreenSpaceQuad : MonoBehaviour {
    ...
    void RenderQuad() {
      if (sizeToBounds) {
        UnityEngine.Profiling.Profiler.BeginSample("ScreenSpaceQuad.Render.Calculate Screen Rect");
          // Refresh the world-space bounds verts of our target object
          UpdateBoundsVertices();
          UnityEngine.Profiling.Profiler.BeginSample("ScreenSpaceQuad.Render.Space Conversion");
          ...
          UnityEngine.Profiling.Profiler.BeginSample("ScreenSpaceQuad.Render.Calculate Rect Extents");
      ...
      UnityEngine.Profiling.Profiler.BeginSample("ScreenSpaceQuad.Render.Draw Quad");
        GL.PushMatrix();
        GL.LoadOrtho();
        material.SetPass(0);
        GL.Begin(GL.QUADS);
    ...
    void UpdateBoundsVertices() {
      UnityEngine.Profiling.Profiler.BeginSample("ScreenSpaceQuad.Render.Update Bounds Vertices");
